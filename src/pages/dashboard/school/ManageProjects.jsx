...
const ManageProjects = () => {
  ...
  return (
    <DashboardLayout role="school" userName={profile.principalName} userSub={profile.district} title="Manage Projects" subtitle="All infrastructure projects" backgroundClass="bg-[#f8f9fc]">
