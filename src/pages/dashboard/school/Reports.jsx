...
const Reports = () => {
  ...
  return (
    <DashboardLayout role="school" userName={profile.name} userSub={profile.district} title="Official School Audit Reports" subtitle={profile.name} notifications={[1, 2]}>
