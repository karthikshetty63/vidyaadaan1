...
const categoryIcons = {
  "Classroom": "🏫", "Library": "📚", "Computer Lab": "💻", "Drinking Water": "🚰",
  "Electricity": "⚡", "Science Lab": "🔬", "Toilets": "🚻", "Playground": "⚽",
  "Campus": "🏛️", "Mid-Day Meal": "🍱", "Transportation": "🚌", "Inclusive Education": "♿",
  "Arts": "🎨", "Digital Learning": "📱", "Health": "🩺", "Other": "📦",
};
  ...
  return (
    <div className="flex h-screen bg-[#f8f9fc] overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <DashboardNavbar role="school" title="Infrastructure Needs" subtitle="School infrastructure management" />
