  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <DashboardNavbar role="school" title="School Profile Management" subtitle={profile.name} notifications={[1, 2]} />
                ...
                {facilities.map((f) => (
                  <div key={f.label} className="p-3 bg-slate-50 rounded-xl flex items-center justify-between">
                    ...
                    <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-black border ${
                      f.available ? "bg-emerald-50 text-emerald-700 border-emerald-200" : "bg-amber-50 text-amber-700 border-amber-200"
                    }`}>
