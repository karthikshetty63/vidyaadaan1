                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="px-4 pb-3 flex items-center justify-between">
                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${proj.status === "Completed" ? "bg-emerald-50 text-emerald-700 border-emerald-200" :
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                {NOTIFICATIONS_LIST.map((notif, i) => (
                  <div
                    key={notif.id}
                    className={`flex items-start gap-3 px-4 py-3.5 hover:bg-slate-50/70 transition-colors ${i < NOTIFICATIONS_LIST.length - 1 ? "border-b border-slate-50" : ""
                  ...
                  >
                    <div className="relative h-32 overflow-hidden">
                      ...
                      <div className="absolute top-2.5 left-3 right-3 flex items-center justify-between">
                        ...
                        <span className={`px-2.5 py-1 rounded-full backdrop-blur-md text-[9px] font-bold ${evt.status === "Fully Sponsored"
